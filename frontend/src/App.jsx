...
const ONBOARDING_SLIDES = [
  {
    ...
    desc: 'Upload your Summary of Benefits and Coverage (SBC) PDF or paste the text. PolicyCrab extracts your deductibles, copays, and coverage limits automatically.',
    color: '#dc2626',
  },
  {
    icon: '🧾',
    ...
    desc: 'Upload your Explanation of Benefits (EOB) or describe what happened — the service, provider, billed amount, and any denial reason. Our engine auto-fills from your EOB.',
    color: '#d97706',
  },
  {
    icon: '⚖️',
    ...
    desc: 'The AI drafts a legally grounded appeal letter citing your exact state regulations, CARC codes, and policy terms. Download it as a PDF and mail it certified.',
    color: '#16a34a',
  },
]
